...
def generate_intelligence_report(
    ...
    if prediction:
        ...
        if top_result:
            ...
            _lat = float(top_atm.latitude) if (top_atm and top_atm.latitude is not None) else None
            _lng = float(top_atm.longitude) if (top_atm and top_atm.longitude is not None) else None
            top_result_dict = {
